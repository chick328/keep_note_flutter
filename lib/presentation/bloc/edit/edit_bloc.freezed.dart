...
return cancelScheduledNotification(_that);case _DeleteNote() when deleteNote != null:
...
return cancelScheduledNotification(_that);case _DeleteNote():
...
return cancelScheduledNotification();case _DeleteNote() when deleteNote != null:
return deleteNote();case _:
  return orElse();
...
return cancelScheduledNotification();case _DeleteNote():
return deleteNote();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String? id)?  fetchNoteById,TResult? Function( String title)?  onTitleChanged,TResult? Function( String content)?  onContentChanged,TResult? Function()?  saveNote,TResult? Function( List<File> images)?  pickImages,TResult? Function( DateTime dateTime)?  scheduleNotification,TResult? Function()?  cancelScheduledNotification,TResult? Function()?  deleteNote,}) {final _that = this;
switch (_that) {
case _FetchNoteById() when fetchNoteById != null:
return fetchNoteById(_that.id);case _OnTitleChanged() when onTitleChanged != null:
return onTitleChanged(_that.title);case _OnContentChanged() when onContentChanged != null:
...
class _DeleteNote implements EditEvent {
  const _DeleteNote();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DeleteNote);
}
